	...
	public function penci_update_notice(){
		if ( penci_is_new_update() ) {
			...
			<div class="notice pc-update-notice">
				...
				<p>You can click <a href="https://themeforest.net/item/soledad-multiconcept-blogmagazine-wp-theme/12945398#item-description__update-changelog" target="_blank">here</a> to check what's new in the newest version also.</p>
