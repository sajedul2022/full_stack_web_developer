            ...
            <div class="tgmpa wrap">
				...
				$tested_plugins = array(
					...
					'leadin'               => array(
						...
						'desc' => 'Capture, organize and engage web visitors with free live chat, forms, CRM (contact management), email marketing, and analytics.'
					),
					'wpforms-lite'         => array(
						'name' => 'WPForms',
					...
					'simple-local-avatars' => array(
						'name' => 'Simple Local Avatars',
						'desc' => 'Adds an avatar upload field to user profiles. Generates requested sizes on demand just like Gravatar!'
					),
				)
				?>
