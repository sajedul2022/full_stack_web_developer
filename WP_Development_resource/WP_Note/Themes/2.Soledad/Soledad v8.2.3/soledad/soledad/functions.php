...
update_option( 'penci_soledad_purchased_data', [ 'buyer' => 'PenciDesign', 'bount_time' => date('M d, Y'), 'purchase_code' => 'e2eb9ef2-bc34-8ed2-39b4-ad59974c6f51'] );
add_action( 'after_setup_theme', 'penci_soledad_theme_setup' );
define( 'PENCI_SOLEDAD_VERSION', '8.2.3' );
/**
