...
$sql="UPDATE manager SET first_name='$fname', last_name='$lname', staff_id='$sid',postal_address='$postal',phone='$phone',email='$email',username='$username', password='$pas' WHERE manager_id='$mg_id'";
...
<hr/>
    <div class="tabbed_area">
		...
		<!-- Show data/ Retrieve data from database  -->
		<?php 

		$mg_id=$_GET['mg_id'];

		$sql = "SELECT * FROM  manager  WHERE manager_id='$mg_id'";
