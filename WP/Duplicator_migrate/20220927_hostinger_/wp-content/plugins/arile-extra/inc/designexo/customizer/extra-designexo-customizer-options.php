...
function arileextra_designexo_frontpage_sections_settings( $wp_customize ){
	...
	if ( 'Architect Decor' != $activate_theme && 'IntecoPress' != $activate_theme && 'Monster Dark' != $activate_theme && 'NewsMedia' != $activate_theme && 'SpiceMag' != $activate_theme && 'DesignTech' != $activate_theme){
...
function arileextra_designexo_customizer_selective_refresh_settings($wp_customize) {
	...
	$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';	
		...
		if('Empresa' == $activate_theme || 'Monster Dark' == $activate_theme || 'NewsMedia' == $activate_theme || 'SpiceMag' == $activate_theme || 'DesignTech' == $activate_theme){ $service_area_des = 'We offer many services to growth'; }
    ...
    // Project
		...
		if('Empresa' == $activate_theme || 'Monster Dark' == $activate_theme || 'NewsMedia' == $activate_theme || 'SpiceMag' == $activate_theme || 'DesignTech' == $activate_theme){ $project_area_des = 'Our latest works'; }
	...
	// Testimonial
		...
		if('Empresa' == $activate_theme || 'Monster Dark' == $activate_theme || 'NewsMedia' == $activate_theme || 'SpiceMag' == $activate_theme || 'DesignTech' == $activate_theme){ $testimonial_area_des = 'Happy clients say'; }
