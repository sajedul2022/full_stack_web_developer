...
if('Empresa' == $activate_theme || 'Monster Dark' == $activate_theme || 'NewsMedia' == $activate_theme || 'SpiceMag' == $activate_theme || 'DesignTech' == $activate_theme){
	...
	<div class="row theme-services-content">
		...
		foreach ( $designexo_service_content as $features_item ) {
			...
			<div class="col-lg-4 col-md-6 col-sm-12">				
					<article class="service-content<?php if('Empresa' == $activate_theme || 'NewsMedia' == $activate_theme || 'SpiceMag' == $activate_theme){ echo '-two media'; }?> wow animate fadeInUp" data-wow-delay=".3s">
					<?php if($features_item->choice == 'customizer_repeater_image'){ ?>
							<?php if ( ! empty( $image ) ) : ?>
							<figure class="service-content-thumbnail<?php if('Empresa' == $activate_theme || 'NewsMedia' == $activate_theme || 'SpiceMag' == $activate_theme){ echo '-two'; }?>">
								<?php if ( ! empty( $link ) ) : ?>
						...
						<?php } else if($features_item->choice =='customizer_repeater_icon'){ ?>
							<?php if ( ! empty( $icon ) ) :?>
							<figure class="service-content-thumbnail<?php if('Empresa' == $activate_theme || 'NewsMedia' == $activate_theme || 'SpiceMag' == $activate_theme){ echo '-two media'; }?>">
									<?php if ( ! empty( $link ) ) : ?>
						...
						<?php if($activate_theme == 'Empresa' || 'NewsMedia' == $activate_theme  || 'SpiceMag' == $activate_theme){echo '<div class="media-body">';} ?>
							<?php if ( ! empty( $title ) ) : 
								if(empty($link)){ ?>
							...
							<?php endif; ?>	
						<?php if($activate_theme == 'Empresa' || 'NewsMedia' == $activate_theme  || 'SpiceMag' == $activate_theme){echo '</div>';} ?>
            ...
            <?php } ?>
            <?php if('Empresa' == $activate_theme || 'NewsMedia' == $activate_theme || 'SpiceMag' == $activate_theme){ ?>
				<div class="col-lg-4 col-md-6 col-sm-12">				
