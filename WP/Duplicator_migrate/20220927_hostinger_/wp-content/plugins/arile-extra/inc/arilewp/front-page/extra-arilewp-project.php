...
if($arilewp_project_disabled == true): ?>
	<section class="theme-block theme-project <?php if($activate_theme == 'Business Street' || $activate_theme == 'Alberta') { echo 'theme-bg-dark'; } else { echo 'theme-bg-grey';} ?>" id="theme-project">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php if($arilewp_project_area_title != null): ?>
						<p class="theme-section-subtitle <?php if($activate_theme == 'Business Street' || $activate_theme == 'Alberta') { echo 'text-light'; } ?>"><?php echo wp_kses_post($arilewp_project_area_title); ?></p>
					<?php endif; ?>
					<?php if($arilewp_project_area_des != null): ?>
						<h2 class="theme-section-title <?php if($activate_theme == 'Business Street' || $activate_theme == 'Alberta') { echo 'text-light'; } ?>"><?php echo wp_kses_post($arilewp_project_area_des); ?></h2>
					<?php endif; ?>
