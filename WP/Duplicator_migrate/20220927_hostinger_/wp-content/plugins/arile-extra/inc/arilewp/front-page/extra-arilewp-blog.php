	 ...
	 <?php if($arilewp_blog_area_title != null || $arilewp_blog_area_des != null): ?>
        ...
        $post_args = array( 'post_type' => 'post', 'category__in' => $arilewp_theme_blog_category, 'post__not_in'=>get_option("sticky_posts")) ;
			...
			{	
				...
				{ ?>
					<div class="col-lg-<?php if($activate_theme == 'Business Street' || $activate_theme == 'InteriorPress') { echo '6'; } elseif($activate_theme == 'Architect Design' || $activate_theme == 'Ariletech' || $activate_theme == 'DesignHub' || $activate_theme == 'Alberta') { echo '4'; } else { echo '3';}   ?> col-md-6 col-sm-12">
