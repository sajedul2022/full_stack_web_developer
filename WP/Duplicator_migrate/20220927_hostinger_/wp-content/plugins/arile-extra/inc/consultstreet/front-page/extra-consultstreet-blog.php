...
if($consultstreet_blog_disabled == true): ?>
	<section class="theme-block theme-blog <?php if($activate_theme == 'BrightPress' || $activate_theme == 'FitnessBase' || $activate_theme == 'Beauty Spa Salon' || 'Arvada' == $activate_theme) { echo 'list-view-news'; } ?><?php if('EnvoPress' == $activate_theme){echo 'vrsn-three';}?>" id="theme-blog">
	 <?php if($consultstreet_blog_area_title != null || $consultstreet_blog_area_des != null): ?>
		...
		<?php endif; ?>
		<div class="<?php if($activate_theme == 'Arvada'){echo 'container-full';} else{echo 'container';} ?>">
			<div class="row">
        <?php
        $post_args = array( 'post_type' => 'post', 'category__in' => $consultstreet_theme_blog_category, 'post__not_in'=>get_option("sticky_posts")) ;
			...
			{	
				...
				<?php if($activate_theme == 'BrightPress' || $activate_theme == 'FitnessBase' || $activate_theme == 'Beauty Spa Salon' || 'Arvada' == $activate_theme): ?>
