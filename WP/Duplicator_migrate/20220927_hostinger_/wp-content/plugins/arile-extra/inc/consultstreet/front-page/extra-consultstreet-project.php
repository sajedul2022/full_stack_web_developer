<?php
if('ConsultStreet' == $activate_theme || 'BrightPress' == $activate_theme || 'AssentPress' == $activate_theme || 'EnvoPress' == $activate_theme || 'Arvada' == $activate_theme){	   $title = 'Our Latest Projects';
		...
		<div class="<?php echo esc_html($consultstreet_project_front_container_size); ?>">
			<div class="row theme-project-row">		
				...
				<?php } } else {
							...
							if('EnvoPress' == $activate_theme || 'Arvada' == $activate_theme){	
								$project1_image = '17';
								$project2_image = '18';
								$project3_image = '19';
								$project4_image = '20';
