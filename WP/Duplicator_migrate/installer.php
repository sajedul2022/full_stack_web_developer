...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220927_hostinger_df76aa11809512f58327_20220927123826_archive.zip';
        const ARCHIVE_SIZE       = '26614523';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'df76aa1-27123826';
        const SECONDARY_PACKAGE_HASH = 'b115b27-27123826';
        const VERSION            = '1.5.0';
